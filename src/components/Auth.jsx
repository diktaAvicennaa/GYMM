...
export default function Auth() {
  ...
  const handleGoogleAuth = async () => {
    ...
    // Kalau sukses, user akan di-redirect ke Google, jadi nggak perlu setLoading(false)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-base-300 to-base-200 flex items-center justify-center p-4">
      ...
      <div className="card w-full max-w-md bg-base-100 shadow-2xl animate-float">
        <div className="card-body p-8">
          {/* Header dengan Dumbbell Animasi */}
          <div className="text-center mb-6">
            <div className="relative w-20 h-20 mx-auto mb-4">
              <div className="absolute inset-0 rounded-full bg-primary animate-pulse-ring"></div>
              <div className="relative w-full h-full bg-primary/10 rounded-2xl flex items-center justify-center animate-lift">
                <svg 
                ...
                >
                  ...
                  <rect x="5.5" y="9" width="1.5" height="6" rx="0.5" />
                  <rect x="17" y="9" width="1.5" height="6" rx="0.5" />
